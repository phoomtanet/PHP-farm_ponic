  ...
  <div class="pt-5 main-content-div" style=" text-align: center;">
    ...
    <div class="container" style="margin-top: 20px;">
      <table class="table table-striped table-bordered">
        <caption class="caption-top">ตารางแสดงข้อมูลราคาผัก</caption>
        <thead>
        ...
        <tbody>
          <?php
          while ($row_pri = mysqli_fetch_array($result_pri)) {
          ?>
            <tr>
              <!-- <td><?= $row_pri["id_vegetableprice"] ?></td> -->
              <td><?= $row_pri["vegetablepricedate"] ?></td>
              <td><?= $row_pri["vegetable_name"] ?></td>
              <td><?= $row_pri["price"] ?></td>
              <!-- <td style="border: none;">
                <a class="" style="color: red;" 
                href="../phpsql/delete_data.php?id=<?= $row_pri['id_vegetableprice'] ?>&tb=tb_vegetableprice&idtb=id_vegetableprice&location=../php/ShowPrice.php" 
                onclick="Del(this.href);return false;"><i class="fa-regular fa-trash-can fa-xl"></i></a>
              </td> -->
              <!-- <td style="border: none;"> -->
                <!-- <a class="update_data " style="color: orange;" id="<?= $row['id_vegetable']; ?>" data-bs-toggle="modal" data-bs-target="#update_data_Modal"><i class="fa-regular fa-pen-to-square fa-xl"></i></a> -->
              <!-- </td> -->
            </tr>
          <?php
          }
    ...
    <div class="modal-content border-dark border-4">
      ...
      <div class="modal-body">
        ...
        <form method="post" action="../phpsql/insert_vegatable.php" enctype="multipart/form-data">
          ...
          <select class="form-select" name="fertilizer" id="fertilizer" required>
